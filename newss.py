...
if logo_path and not logo_b64:
    st.sidebar.caption("⚠️ Logo not found at the given path. The app will continue without it.")
...
st.sidebar.markdown("---")
st.sidebar.write(f"**Data store:** {' Postgres' if DB_OK and DB_MODE=='postgres' else ' Local SQLite (fallback)'}")
...
# ==== 🧾 Paste JD ====
st.markdown("### 🧾 Paste Job Description (JD) (optional but recommended)")
